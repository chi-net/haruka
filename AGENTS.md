...
- `/dashboard` 对用户统一称为“仪表板”，集中快速记账、账户概览、转账、借还、资金动态及收支图表；日报按今日 24 小时、周/月/年报分别按近 7/30/365 个自然日聚合。`/transfers`、`/debts` 的 GET 只重定向到仪表板，POST 操作完成后也返回仪表板。借贷对象由 `/debt-people` 独立管理并显示在顶部导航
